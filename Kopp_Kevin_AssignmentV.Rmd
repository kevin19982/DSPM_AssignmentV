...
event_info_complete_graphversion <- event_info_complete %>% filter(between(latitude, 47.271679, 55.0846))

# drawing the plot
ggplot() + 
  geom_point(data = event_info_complete_graphversion, aes(x = longitude, y = latitude), col = "red", size = 0.01) +
  geom_polygon(
